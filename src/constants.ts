...
export const FD_WIN_POINTS = 6;
export const DK_WIN_POINTS = 4;
export const QUALITY_START_POINTS = 4;
...
export const COMPLETE_GAME_POINTS = 2.5;
export const COMPLETE_GAME_SHUTOUT_POINTS = 2.5;
export const NO_HITTER_POINTS = 5;
